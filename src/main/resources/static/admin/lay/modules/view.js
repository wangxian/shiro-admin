    ...
    .define(
        ...
        function (exports) {
          ...
          self.loadHtml = function (url, callback) {
            ...
            // 避免请求的时候，多了一个/, /admin/views//system
            if (url.slice(0, 1) == "/") {
              url = url.slice(1);
            }
          ...
          self.tab = {
            ...
            init        : function () {
              ...
              $(document).on('click', btnCls, function (e) {
                ...
                if ($(e.target).hasClass('admin-tabs-close')) {
                  tab.del(url)
                } else {
            ...
            del         : function (url, backgroundDel) {
              ...
              if (backgroundDel === undefined) {
                if (thisMenu.hasClass('admin-tabs-active')) {
            ...
            change      : function (route, callback) {
              ...
              if (existsTab) {
                ...
                self.loadHtml(fileurl, function (res) {
                  var htmlElem = $(
                      "<div><div class='admin-tabs-item' lay-url='" +
                      fileurl +
                      "'>" +
                      res.html +
                      '</div></div>'
          ...
          self.renderLayout        = function (callback, url) {
            ...
            self.render(url, function (res) {
              ...
              if (conf.viewTabs === true) {
                self.containerBody.addClass('admin-tabs-body')
              }
