...
import io.company.project.monitor.mapper.LogMapper;
...
public class LogServiceImpl extends ServiceImpl<LogMapper, Log> implements ILogService {
    ...
    public void saveLog(ProceedingJoinPoint point, Log log) throws JsonProcessingException {
        ...
        io.company.project.common.annotation.Log logAnnotation = method.getAnnotation(io.company.project.common.annotation.Log.class);
