...
import io.webapp.common.properties.ShiroProperties;
...
public class ShiroEarlyBeanRegistrar {
    ...
    @Bean
    public ShiroFilterFactoryBean shiroFilterFactoryBean(@Lazy DefaultWebSecurityManager securityManager, @Lazy AdminProperties adminProperties) {
        ShiroProperties shiro = adminProperties.getShiro();
