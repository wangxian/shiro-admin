...
import static com.company.project.monitor.endpoint.AdminMetricsEndpoint.AdminMetricResponse;
...
public class ViewController {
    ...
    public String jvmInfo(Model model) {
        List<AdminMetricResponse> jvm = actuatorHelper.getMetricResponseByType("jvm");
    ...
    public String tomcatInfo(Model model) {
        List<AdminMetricResponse> tomcat = actuatorHelper.getMetricResponseByType("tomcat");
    ...
    public String serverInfo(Model model) {
        List<AdminMetricResponse> jdbcInfo = actuatorHelper.getMetricResponseByType("jdbc");
        List<AdminMetricResponse> systemInfo = actuatorHelper.getMetricResponseByType("system");
        List<AdminMetricResponse> processInfo = actuatorHelper.getMetricResponseByType("process");
